...
<div class="mt-3 ">
    ...
    <table id="award-table" class="table table-bordered table-sm" width="100%" cellspacing="0">
        <thead>  
            <th>Delete</th>
            <th>Edit</th>
            <th>Delete</th>
            <th><i class="fa fa-user"></i> Award Name</th>
            <th>Company</th>
...
$(document).ready(function(){
    ...
    var $datatable = $("#award-table").DataTable({ 
        "ajax": {
          "url" :"{{ url('awards/data/table') }}",
          "dataSrc": "", 
        },
        
        "columns": [
            { 
                "data": "award_id", "width": "50px", "render": function (data) {
                return '<a class="delete" href="javascript:void(0)" value="'+data+'"><i class="fa fa-trash-alt"></i></a>';
 
                }
            },
                { 
                "data": "award_id", "width": "50px", "render": function (data) {
                return '<a class="edit" href="javascript:void(0)" value="'+data+'"><i class="fa fa-pen"></i></a>'; 
                
                }
            },
            { 
                "data": "award_id", "width": "50px", "render": function (data) {
                return '<a class="view" href="javascript:void(0)" value="'+data+'" data-toggle="modal" data-target="#vewmodal"><i class="fa fa-eye"></i></a>'; 
                }
            },
            {"data": "name" , "responsive": true, "lengthChange": true, "autoWidth": true,},
            {"data": "company_id", "responsive": true, "lengthChange": true, "autoWidth": true,},
            {"data": "gift_item", "responsive": true, "lengthChange": true, "autoWidth": true,},
            {"data": "award_month_year", "responsive": true, "lengthChange": true, "autoWidth": true,},
        ],
    ...
    $(document).on('click', '.delete', function(e){
           ...
           $.ajax({
            ...
            success : function(data){
                toastr.error("Award "+data.message);
                $datatable.ajax.reload();
            }
           }); 
